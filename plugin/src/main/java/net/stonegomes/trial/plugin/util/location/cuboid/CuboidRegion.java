package net.stonegomes.trial.plugin.util.location.cuboid;
...
public class CuboidRegion implements Iterable<Block>, Cloneable, ConfigurationSerializable {
    ...
    public CuboidRegion(Location l1, Location l2, Location spawn) {
        this(l1, l2);
    ...
    public CuboidRegion contract(CuboidDirection dir) {
        CuboidRegion face = getFace(dir.opposite());
        switch (dir) {
            case Down:
